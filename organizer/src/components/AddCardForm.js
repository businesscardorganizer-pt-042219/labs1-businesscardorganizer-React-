      ...
      <div className="add-card-form-wrapper">
        <div className="add-card-form-content">
          <div className="add-card-form-header">
            ...
            <p>
              Fill in some basic information and we'll create card for you to
          ...
          <form onSubmit={this.submit}>
            ...
            this.state.data.gitHub !== "" ? (
              ...
              <button className="btn not-active">Create card</button>
            )}
          </form>
        </div>
        <div className="hide-form-arrow" onClick={this.props.hideForm}>
          ⬆︎
        </div>
      </div>
    );
